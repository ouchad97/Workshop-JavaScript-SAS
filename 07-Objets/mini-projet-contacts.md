...
Créer un programme JavaScript pour gérer un carnet de contacts. Le programme doit permettre à l'utilisateur d'ajouter, de rechercher, de modifier, de supprimer et d'afficher des contacts. Chaque contact doit contenir un nom, un numéro de téléphone et une adresse e-mail.
...
Ces informations sont regroupées dans un objet `Contact`, puis les contacts sont stockés dans un tableau.
...
- **Objets** : Pour regrouper les informations liées à un contact.