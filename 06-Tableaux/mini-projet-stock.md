...
## Objectif
Le projet consiste à créer un programme JavaScript qui permet de gérer le stock de livres dans une librairie. Le programme doit offrir les fonctionnalités suivantes :
...
- Le programme demande les informations suivantes pour chaque livre :
  ...
  - Prix du livre.
  - Quantité en stock.
- Chaque livre est représenté par un objet contenant son titre, son auteur, son prix et sa quantité. Les livres sont stockés dans un tableau.
...
- Le programme JavaScript calcule et affiche le nombre total de livres en stock, en additionnant les quantités de tous les livres.
...
- **Tableaux et objets** : Pour stocker plusieurs livres et regrouper leurs informations.
